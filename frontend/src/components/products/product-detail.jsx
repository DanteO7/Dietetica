        ...
        <div className="pl-16 flex flex-col gap-3 text-[18px]">
          ...
          <div className="flex justify-between items-end">
            ...
            <div className="flex flex-col">
              ...
              <button
                ...
                className="shadow-md bg-red-500 text-[#efefef] rounded-[7px] px-2.5 py-1.5 mt-2 hover:bg-red-700 transition-all duration-200 cursor-pointer"
              >
                Eliminar producto
              </button>
            </div>
          ...
          <div className="flex gap-5 items-center ">
            ...
            <button
              ...
              className="border shadow-md rounded-[7px] px-2 py-1 mt-2 hover:bg-[#e1e1e9] transition-all duration-200 cursor-pointer"
            >
              Agregar
            </button>
          </div>
